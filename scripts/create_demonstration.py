"""
Modified libero/scripts/libero_100_collect_demonstrations.py
...
def collect_human_trajectory(
    ...
    def completion_listener_on_release(key):
        try:
            ...
            pass
    completion_listener = Listener(on_release=completion_listener_on_release)
    completion_listener.start()
