...
def place_the_mug_on_the_stove():
	return base_bddl.format("(And (On moka_pot_1 flat_stove_1_cook_region) (Not (Contact moka_pot_1)))")

def reach_the_stove():
	bddl = base_bddl.format("(And (On moka_pot_1 flat_stove_1_cook_region) (Not (Contact moka_pot_1)) (Reach flat_stove_1_knob_region {}))")
	return [bddl.format(reach_distance) for reach_distance in np.arange(0.4, -0.0001, -0.05)]

def turnon_the_stove():
	bddl = base_bddl.format("(And (On moka_pot_1 flat_stove_1_cook_region) (Not (Contact moka_pot_1)) (Turnon flat_stove_1 {}))")
